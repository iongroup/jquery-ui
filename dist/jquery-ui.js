/*! jQuery UI - v1.12.0-pre-d11 - 2020-01-28
* http://jqueryui.com
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-blind',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-bounce',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-explode',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-highlight',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-scale',[
			"jquery",
			"../version",
			"../effect",
			"./effect-size"
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-pulsate',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-shake',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-slide',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/effects/effect-transfer',[
			"jquery",
			"../version",
			"../effect"
		], factory );
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/widgets/autocomplete',[
			"jquery",
			"./menu",
			"../keycode",
			"../position",
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/widgets/controlgroup',[
			"jquery",
			"../widget"
		], factory );
	} else {
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/widgets/checkboxradio',[
			"jquery",
			"../escape-selector",
			"../form-reset-mixin",
			"../labels",
