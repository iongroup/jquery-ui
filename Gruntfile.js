    ...
    requirejs: {
        js: {
            options: {
                ...
                exclude: [ "jquery" ],
                include: expandFiles( [ "ui/**/*.js", "!ui/widgets/tooltip.js", "!ui/core.js", "!ui/i18n/*" ] ),
    ...
    getAuthors({
        ...
        authors = authors.map(function( author ) {
            if ( author.match( /^Dan Strohl </ ) ) {
                return "Dan Strohl";
			} else if ( author.match( /^Jacek Jedrzejewski </ ) ) {
				return "Jacek Jedrzejewski (http://jacek.jedrzejewski.name)";
...
grunt.registerTask( "quick", [ "lint", "requirejs" ]);
